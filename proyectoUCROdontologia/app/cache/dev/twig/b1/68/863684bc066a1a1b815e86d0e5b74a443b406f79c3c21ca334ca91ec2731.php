...
class __TwigTemplate_b168863684bc066a1a1b815e86d0e5b74a443b406f79c3c21ca334ca91ec2731 extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 38
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("odontologo_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "cedula", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
