 ...
 */
class Expediente extends \ConnectionBDBundle\Entity\Expediente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ConnectionBDBundle\\Entity\\Expediente' . "\0" . 'id', '' . "\0" . 'ConnectionBDBundle\\Entity\\Expediente' . "\0" . 'idpaciente');
        }
