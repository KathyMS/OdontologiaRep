 ...
 */
class Odontologo extends \ConnectionBDBundle\Entity\Odontologo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ConnectionBDBundle\\Entity\\Odontologo' . "\0" . 'id', '' . "\0" . 'ConnectionBDBundle\\Entity\\Odontologo' . "\0" . 'nombre', '' . "\0" . 'ConnectionBDBundle\\Entity\\Odontologo' . "\0" . 'telefono', '' . "\0" . 'ConnectionBDBundle\\Entity\\Odontologo' . "\0" . 'correoElectronico', '' . "\0" . 'ConnectionBDBundle\\Entity\\Odontologo' . "\0" . 'practicante', '' . "\0" . 'ConnectionBDBundle\\Entity\\Odontologo' . "\0" . 'cedula');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Odontologo $proxy) {
    ...
    public function setPracticante($practicante)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPracticante', array($practicante));

        return parent::setPracticante($practicante);
    }
    ...
    public function getPracticante()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPracticante', array());

        return parent::getPracticante();
    }
