...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '163.178.107.130', 'port' => '3306', 'dbname' => 'u-dental', 'user' => 'adm', 'password' => 'saucr.092', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\ConnectionBDBundle\\Resources\\config\\doctrine') => 'ConnectionBDBundle\\Entity'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'ConnectionBDBundle\\Entity');
        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ConnectionBDBundle' => 'ConnectionBDBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_effbf557c79379b8b84927ebbf7ddeb98387363183134b04e0d975d341ba7fdc');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AdministradorBundle/Resources/views'), 'Administrador');
        $instance->addPath(($this->targetDirs[3].'\\src\\EstudianteBundle/Resources/views'), 'Estudiante');
        $instance->addPath(($this->targetDirs[3].'\\src\\ConnectionBDBundle/Resources/views'), 'ConnectionBD');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdministradorBundle' => 'AdministradorBundle\\AdministradorBundle',
                'EstudianteBundle' => 'EstudianteBundle\\EstudianteBundle',
                'ConnectionBDBundle' => 'ConnectionBDBundle\\ConnectionBDBundle',
            ),
